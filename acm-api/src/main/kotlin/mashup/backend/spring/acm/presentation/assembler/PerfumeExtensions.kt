...
import mashup.backend.spring.acm.presentation.api.perfume.PerfumeDetailResponse
...
fun Perfume.toPerfumeDetail(similarPerfumes: List<PerfumeSimpleVo>): PerfumeDetailResponse {
